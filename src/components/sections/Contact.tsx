...
const ContactInfo = () => {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <motion.button
        onClick={() => {
          // Find the chatbot toggle button and click it if possible, or we could lift state.
          // For now, since it's global, we can use a custom event or just trust the floating button.
          // Let's just make this button scroll to the bottom right where the chatbot is.
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              <motion.h3 className="mb-6 font-display text-2xl font-bold text-slate-900 drop-shadow-[0_8px_24px_rgba(99,102,241,0.12)]"
                animate={{ y: [0, -4, 0, 4, 0], color: ['#1e293b', '#6366f1', '#1e293b'] }}
                transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
              >
                Let’s Work Together
