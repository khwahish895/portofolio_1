...
const INTERNSHIPS = [
  ...
  },
  {
    ...
    company: "Internshala Trainings",
    year: "2026",
    subtext: "2 months remote",
    icon: Code,
    color: "text-indigo-500",
    bg: "bg-indigo-50",
    points: [
      "Built responsive UIs with React & Tailwind, integrating AI features",
      "Worked on full-stack APIs with backend and AI model integration",
      "Improved performance and UX using AI-driven optimizations"
    ]
  }
];
    ...
    <div className="relative flex gap-8 pl-4 lg:pl-0">
      ...
      <div className={`flex w-full flex-col lg:flex-row ${index % 2 === 0 ? "lg:flex-row-reverse" : ""}`}>
        ...
        <motion.div
          ...
          transition={{ default: { duration: 0.5, delay: index * 0.2 }, x: {duration:12, repeat:Infinity, ease:'easeInOut'}, rotateY: {duration:20, repeat:Infinity, ease:'linear'} }}
  ...
  return (
    <div className="w-full py-12">
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6, delay: 0, type: "spring" as any }}
      ...
      >
        ...
        >
My <span className="text-blue-400">industrial trainings</span>
        </motion.h2>
