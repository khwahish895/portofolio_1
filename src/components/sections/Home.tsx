    ...
    <div className="grid min-h-[calc(100vh-140px)] w-full grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
      ...
      <div className="flex flex-col items-center justify-center space-y-8 lg:col-span-5 lg:items-start lg:pl-8">
        ...
        >
          ...
          <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-rose-500 opacity-30 blur-sm transition duration-1000 group-hover:opacity-60 group-hover:duration-200 animate-spin-slow" />

          <div className="relative h-64 w-64 overflow-hidden rounded-full border-4 border-white bg-slate-100 shadow-lg transition-transform duration-500 group-hover:scale-[1.02]">
            <motion.img
              src="/home.png"
              alt="Khwahish Singh"
        ...
        >
          ...
          <motion.a
            variants={itemVariants}
            href="https://drive.google.com/file/d/1BW1j4ucSBEJqXdHhgURsdLmNOEYOtZZ9/view?usp=drive_link"
            target="_blank"
