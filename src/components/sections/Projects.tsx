...
const professionalData: Record<ProfCategory, ProjectCardData[]> = {
  Presentation: [
    ...
    },
    {
      ...
      links: [
        { label: "View Presentation", url: "https://docs.google.com/presentation/d/1kx_PcnXL7xJFuIiQ1dIOzMiSQpxhGVF-/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true", icon: Presentation },
        { label: "Download Slides", url: "https://drive.google.com/file/d/1E3wIOgo_0cidaTJYr7heLvgXI67IqQir/view?usp=drive_link", icon: Download }
      ],
      icon: Cpu,
    ...
    },
    {
      ...
      description: "Built a full stack application integrating modern frontend, scalable backend, and AI-driven features to deliver intelligent, data-informed user experiences.",
      highlights: [
      ...
      links: [
        { label: "View Presentation", url: "https://docs.google.com/presentation/d/1_NS6LpXuaX6ulUqqmUdWevkOyCzSBPKE/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true", icon: Presentation },
        { label: "Download Slides", url: "https://drive.google.com/file/d/1nzKhZ3h_7HnY32FpovVtTNyLhRVhPdk_/view?usp=drive_link", icon: Download }
      ],
      icon: Code,
tech: ["React", "Node.js", "MongoDB", "AI/ML"],
    ...
    },
    {
      ...
      links: [
        { label: "View Presentation", url: "https://docs.google.com/presentation/d/1hrbBrcbsRNdV1_E27I8ilSxsHzhksKIl/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true", icon: Presentation },
        { label: "Download Slides", url: "https://drive.google.com/file/d/1ZVicxvIb6U_VWGPcpfsgFDXDtLQABf5m/view?usp=drive_link", icon: Download }
      ],
      icon: Smartphone,
  ...
  Report: [
    ...
    },
    {
      ...
      links: [
        { label: "View Report", url: "https://docs.google.com/document/d/1mK3pZ0CyYKI_Os5VG6tP2-9Df8opugCa/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true", icon: FileText },
        { label: "Download Report", url: "https://drive.google.com/file/d/1cS-awrV2rVhH5JM3Y1RSeNuO748aLOsR/view?usp=drive_link", icon: Download }
      ],
      icon: Code,
tech: ["React", "Node.js", "MongoDB", "AI/ML"],
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop"
    },
    {
      ...
      links: [
        { label: "View Report", url: "https://docs.google.com/document/d/104P2daQI4yKXeAsQnIbPpIWB84IC4MqZ/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true", icon: FileText },
        { label: "Download Report", url: "https://drive.google.com/file/d/15Zwbsl9VQIfhCWWeXgAkv76mDwPN0vR4/view?usp=drive_link", icon: Download }
      ],
      icon: FileText,
  ...
  Projects: [
    ...
    },
    {
      ...
      links: [
        { label: "View Project", url: "https://drive.google.com/file/d/1oZmDWh4ZQwF7Ub96568FCNIncSgdXtW3/view?usp=drive_link", icon: ExternalLink },
        { label: "Live Demo", url: "https://nexuschat-app.netlify.app/login", icon: Globe },
        { label: "GitHub", url: "https://github.com/khwahish895/chat-application", icon: Github }
      ],
      icon: Code,
tech: ["React", "Node.js", "MongoDB", "AI/ML"],
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop"
    },
    {
      ...
      links: [
        { label: "View Project", url: "https://drive.google.com/file/d/1FUquLiWtcTdAN2VLfNEqL5BW8B-DXLd1/view?usp=drive_link", icon: ExternalLink },
        { label: "Live Demo", url: "https://github.com/khwahish895/android-", icon: Globe },
        { label: "GitHub", url: "https://github.com/khwahish895/android-", icon: Github }
      ],
      icon: Smartphone,
    ...
    },
{
    ...
    {
      title: "DigitalAssist",
      description: "AI-powered virtual assistant helping Indians with daily tasks, government paperwork, and local language support.",
      highlights: [
        "Voice-based assistance in regional languages",
        "Government form simplification",
        "Utility bill payments and reminders"
      ],
      links: [
        { label: "View Demo", url: "https://easy-digital-aid.lovable.app", icon: Globe },
        { label: "View Code", url: "https://github.com/khwahish895/digital-assist-now", icon: Github }
      ],
      icon: Bot,
      tech: ["AI Assistant", "Voice AI"],
      type: "Startup" as const,
      stage: "MVP Stage",
      impact: "AI Assistant · Digital India",
      demoUrl: "https://easy-digital-aid.lovable.app",
      codeUrl: "https://github.com/khwahish895/digital-assist-now",
      presentationUrl: "https://docs.google.com/presentation/d/1UrbByXfWsdG3BPZZqeTdBdGhLshdEvHo/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&h=400&fit=crop"
    },
    {
      title: "DailyTask Helper",
      description: "Flexible task and schedule management app with smart reminders for busy professionals and students.",
      highlights: [
        "Smart recurring task automation",
        "Location-based reminders",
        "Team collaboration features"
      ],
      links: [
        { label: "View Demo", url: "https://easy-digital-help.base44.app", icon: Globe },
        { label: "View Code", url: "https://github.com/khwahish895/your-daily-helper", icon: Github }
      ],
      icon: CheckSquare,
      tech: ["Productivity", "Task Management"],
      type: "Startup" as const,
      stage: "Beta Stage",
      impact: "Productivity · Remote Work",
      demoUrl: "https://easy-digital-help.base44.app",
      codeUrl: "https://github.com/khwahish895/your-daily-helper",
      presentationUrl: "https://docs.google.com/presentation/d/1CNh0YrOSf8z6byjJcVu3Ce7b07iLIguF/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true",
      image: "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=600&h=400&fit=crop"
    },
{
      title: "CleanStart",
      description: "On-demand home and office cleaning service booking platform with verified cleaners.",
      highlights: [
        "Easy booking in few taps",
        "Verified and rated cleaners",
        "Secure payment gateway"
      ],
      links: [
        { label: "View Demo", url: "https://neat-space-ease.lovable.app", icon: Globe },
        { label: "View Code", url: "https://github.com/khwahish895/sparkling-home-design", icon: Github }
      ],
      icon: Sparkles,
      tech: ["Service Platform", "Gig Economy"],
      type: "Startup" as const,
      stage: "Live MVP",
      impact: "Gig Economy · Quick Income",
      demoUrl: "https://neat-space-ease.lovable.app",
      codeUrl: "https://github.com/khwahish895/sparkling-home-design",
      presentationUrl: "https://docs.google.com/presentation/d/1zqjExULxfJb79dZu9fdpbTG3OJKYCSdL/edit?usp=drive_link&ouid=112538470595958137063&rtpof=true&sd=true",
image: "https://images.unsplash.com/photo-1581578731548-c64695cc3522?w=600&h=400&fit=crop"
    }
...
const startupCardVariants = {
  ...
  visible: {
    ...
    y: 0,
    scale: 1,
    transition: { type: "spring" as any as any, stiffness: 90, damping: 20 }
  }
};
...
const STARTUP_ACCENT: Record<string, { gradient: string; glow: string; badge: string }> = {
  ...
  "DigitalAssist": { gradient: "from-blue-500 to-cyan-400", glow: "rgba(37,99,235,0.15)", badge: "bg-blue-500/10 text-blue-400 border-blue-500/20" },
  "DailyTask Helper": { gradient: "from-violet-500 to-purple-400", glow: "rgba(139,92,246,0.15)", badge: "bg-violet-500/10 text-violet-400 border-violet-500/20" },
  "CleanStart": { gradient: "from-amber-500 to-orange-400", glow: "rgba(245,158,11,0.15)", badge: "bg-amber-500/10 text-amber-400 border-amber-500/20" },
};
      ...
      >
        ...
        <div className="mt-auto flex flex-col gap-4 relative z-10">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onPreview}
            className="flex items-center self-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-white opacity-0 hover:opacity-100 -translate-y-1 hover:translate-y-0 transition-all duration-300"
          >
...
const voiceCardVariants = {
  ...
  visible: {
    ...
    y: 0,
    scale: 1,
    transition: { type: "spring" as any as any, stiffness: 100, damping: 20 }
  }
};
...
function ProjectModal({ project, onClose }: { project: ProjectCardData; onClose: () => void }) {
  return (
    ...
    >
      <motion.div
        className="relative max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8 shadow-2xl"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute right-6 top-6 p-2 rounded-xl bg-white/10 hover:bg-white/20 text-white transition-all"
        >
          <X className="h-5 w-5" />
        </button>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              {project.org && <p className="text-sm text-slate-400 mt-1">{project.org}</p>}
            </div>
          </div>
          ...
          {project.highlights && (
            <div>
              <h4 className="text-sm font-bold uppercase tracking-wide text-slate-400 mb-3">Highlights</h4>
          ...
          {project.tech && (
            <div>
              <h4 className="text-sm font-bold uppercase tracking-wide text-slate-400 mb-3">Technologies</h4>
              <div className="flex flex-wrap gap-2">
                {project.tech.map(t => (
                  <span key={t} className="px-3 py-1 bg-white/10 rounded-xl text-xs font-bold text-white border border-white/20">
                    {t}
                  </span>
                ))}
              </div>
            ...
            <div className="pt-6 border-t border-white/10 flex gap-3 flex-wrap">
              {project.links.map((link, i) => (
                <a
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 rounded-2xl text-sm font-bold border border-white/20 transition-all group"
                >
