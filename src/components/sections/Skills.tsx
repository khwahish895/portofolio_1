...
const CategoryCard = ({ category }: CategoryCardProps) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative h-64 w-full overflow-hidden rounded-2xl border border-slate-200 p-6 shadow-sm transition-all duration-300 hover:shadow-2xl ${styles}`}
    >
      {/* Default State */}
      <motion.div
      ...
      >
        <div className={`mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-white/20 ${styles.split(' ').slice(-2).join(' ')}`}>
