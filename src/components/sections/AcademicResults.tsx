...
export default function AcademicResults() {
    ...
    const competitiveData = [
        ...
        { name: "GATE", year: "2026", status: "Appeared", percentile: "" ,link:"#"}
    ];
    ...
    const semesterData = [
        ...
        { sem: "Sem 3", sgpa: "-", year: "2024-25", subjects: ["Java", "Discrete Math", "Digital Logic"], link: "https://drive.google.com/file/d/1pDbKiaF2qWIFnWqkaWdAp_A_CKZdL1ap/view?usp=drive_link" },
        { sem: "Sem 4", sgpa: "-", year: "2024-25", subjects: ["OS", "Algorithms", "DBMS"], link: "https://drive.google.com/file/d/1RrDzT95S610csz7AqKOdfloh1yozogyx/view?usp=drive_link" },
        { sem: "Sem 5", sgpa: "-", year: "2025-26", subjects: ["Computer Networks", "TOC", "Web Tech"], link: "#"},
        { sem: "Sem 6", sgpa: "-", year: "2025-26", subjects: ["Software Eng", "Compiler", "Cloud"], link: "#" },
        { sem: "Sem 7", sgpa: "-", year: "2026-27", subjects: ["Machine Learning", "IoT", "Cyber Security"], link: "#" },
        { sem: "Sem 8", sgpa: "-", year: "2026-27", subjects: ["Project", "Professional Ethics", "Elective"],link: "#" }
    ];
