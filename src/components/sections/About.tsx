    ...
    <div className="grid min-h-[calc(100vh-140px)] w-full grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-400 via-purple-400 to-pink-400 opacity-80 blur-2xl transition-all duration-1000 group-hover:opacity-100 group-hover:duration-200 animate-[spin_30s_linear_infinite_reverse] shadow-[0_0_80px_rgba(147,51,234,0.7)]" />
          
          <div className="relative h-72 w-72 lg:h-96 lg:w-96 overflow-hidden rounded-full border-[3px] border-white/90 bg-gradient-to-br from-slate-50 to-white shadow-2xl ring-4 ring-white/70 transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-[0_0_80px_rgba(147,51,234,0.7)]">
            <motion.img
              src="/about.jpg"
