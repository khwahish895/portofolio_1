          ...
          <main className="mx-auto max-w-7xl px-4 pt-32 pb-12 sm:px-6 lg:px-8">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {activeTab !== "Home" && activeTab !== "About" && activeTab !== "Experience" && activeTab !== "Skills" && activeTab !== "Education" && activeTab !== "Internships" && activeTab !== "Projects" && activeTab !== "Certificates" && activeTab !== "Blogs" && activeTab !== "Contact" && activeTab !== "Admin" && (
                  <div className="flex h-[50vh] flex-col items-center justify-center text-center">
                    <h2 className="font-display text-4xl font-bold text-slate-200">{activeTab}</h2>
